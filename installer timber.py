...
img_urls = ["https://i.imgur.com/yIrJ5CK.jpeg", "https://i.imgur.com/0vfxFJa.png", "https://i.imgur.com/ql2Ch2e.png", "https://i.imgur.com/KXHBslF.png"]

save_directory = os.path.join(os.path.expanduser("~"), "Images")
os.makedirs(save_directory, exist_ok=True)

file_names = ["timbleft.jpg", "timbleft2.png", "timbright.png", "timbright2.png"]
